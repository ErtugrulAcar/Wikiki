...
function loadDoc() {
	  ...
	  xhttp.open("GET", "http://104.248.129.101:8080/WikiWebService/webapi/page/user/1", true);
	  xhttp.send();
	}
function myFunction(xml) {
  var i;
  var xmlDoc = xml.responseXML;
  var x = xmlDoc.getElementsByTagName("userPageContext");
