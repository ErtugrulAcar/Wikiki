	...
	<div style="width: 50%;height:800px; float: left; border: 1px black solid;">
		<div style="width: 80%;height:800px; margin: auto; border: 1px black solid;">
			...
			<div style="width: auto; margin:auto; border: 1px black solid; position: relative;">
				<input id="titleBox" rows="1" cols="72" style="position: relative; margin-bottom: 5px; width : 100%;" placeholder = "Konu giriniz." unselectable="on">
				<textarea id="subject" rows="5" cols="72" style="position: relative; margin-bottom: 5px; width : 100%;" placeholder = "Paragraf giriniz.">
