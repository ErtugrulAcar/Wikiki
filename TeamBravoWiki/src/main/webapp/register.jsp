            ...
            <div class="nav border d-flex justify-content-center py-4 mt-1">
                <div class = "d-block w-75">
                    <form action="/register" method="post">
                        ...
                        <br>
                        <input type="submit" value="Register" class="my-2 btn btn-secondary">
                    </form>
                    <a href="/login"><button class="my-2 btn btn-secondary">Login</button></a>
                </div>
                <div class = "d-block mb-3">
                        <a href="/home"><br>To Continue without sign in...</a>
                </div>
            </div>
    </div>
</center>
